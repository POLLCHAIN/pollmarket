...
export class AuctionBidSuccess extends ethereum.Event {
  get params(): AuctionBidSuccess__Params {
    return new AuctionBidSuccess__Params(this);
  }
}

export class AuctionBidSuccess__Params {
  _event: AuctionBidSuccess;

  constructor(event: AuctionBidSuccess) {
    this._event = event;
  }
  ...
  get auction(): AuctionBidSuccessAuctionStruct {
    return this._event.parameters[1].value.toTuple() as AuctionBidSuccessAuctionStruct;
  }
...
export class AuctionBidSuccessAuctionStruct extends ethereum.Tuple {
...
export class AuctionCanceled__Params {
  ...
  get auction(): AuctionCanceledAuctionStruct {
    return this._event.parameters[0].value.toTuple() as AuctionCanceledAuctionStruct;
  }
}
...
export class SingleAuction__auctionBidsResult {
  value0: Address;
  value1: BigInt;
...
export class SingleAuction__auctionsResult {
  value0: BigInt;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class SingleAuction__getCurrentBidsResult {
  value0: BigInt;
  value1: Address;
...
export class SingleAuction extends ethereum.SmartContract {
  static bind(address: Address): SingleAuction {
    return new SingleAuction("SingleAuction", address);
  }
  ...
  auctionBids(
    param0: BigInt,
    param1: BigInt
  ): SingleAuction__auctionBidsResult {
    let result = super.call(
      "auctionBids",
    ...
    return new SingleAuction__auctionBidsResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }
  ...
  try_auctionBids(
    param0: BigInt,
    param1: BigInt
  ): ethereum.CallResult<SingleAuction__auctionBidsResult> {
    let result = super.tryCall(
      "auctionBids",
      "auctionBids(uint256,uint256):(address,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new SingleAuction__auctionBidsResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
  ...
  auctions(param0: BigInt): SingleAuction__auctionsResult {
    let result = super.call(
      "auctions",
      "auctions(uint256):(uint256,address,uint256,uint256,uint256,address,uint256,address,address,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new SingleAuction__auctionsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_auctions(
    param0: BigInt
  ): ethereum.CallResult<SingleAuction__auctionsResult> {
    let result = super.tryCall(
      "auctions",
      "auctions(uint256):(uint256,address,uint256,uint256,uint256,address,uint256,address,address,bool)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SingleAuction__auctionsResult(
        value[0].toBigInt(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  getCurrentBids(_auctionId: BigInt): SingleAuction__getCurrentBidsResult {
    let result = super.call(
      "getCurrentBids",
    ...
    return new SingleAuction__getCurrentBidsResult(
      result[0].toBigInt(),
      result[1].toAddress()
    );
  }
  ...
  try_getCurrentBids(
    _auctionId: BigInt
  ): ethereum.CallResult<SingleAuction__getCurrentBidsResult> {
    let result = super.tryCall(
      "getCurrentBids",
      "getCurrentBids(uint256):(uint256,address)",
      [ethereum.Value.fromUnsignedBigInt(_auctionId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SingleAuction__getCurrentBidsResult(
        value[0].toBigInt(),
        value[1].toAddress()
      )
    );
