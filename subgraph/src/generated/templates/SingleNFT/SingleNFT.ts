...
export class SingleNFT__ItemsResult {
  value0: BigInt;
  value1: Address;
  value2: string;
  value3: BigInt;
...
export class SingleNFT extends ethereum.SmartContract {
  static bind(address: Address): SingleNFT {
    return new SingleNFT("SingleNFT", address);
  }
  ...
  Items(param0: BigInt): SingleNFT__ItemsResult {
    let result = super.call(
      "Items",
    ...
    return new SingleNFT__ItemsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toString(),
      result[3].toBigInt()
  ...
  try_Items(param0: BigInt): ethereum.CallResult<SingleNFT__ItemsResult> {
    let result = super.tryCall(
      "Items",
      "Items(uint256):(uint256,address,string,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  try_burn(_tokenId: BigInt): ethereum.CallResult<boolean> {
