...
export class MultiItemCreated extends ethereum.Event {
  get params(): MultiItemCreated__Params {
    return new MultiItemCreated__Params(this);
  }
}

export class MultiItemCreated__Params {
  _event: MultiItemCreated;

  constructor(event: MultiItemCreated) {
    this._event = event;
  }
...
export class MultipleNFT__ItemsResult {
  value0: BigInt;
  value1: Address;
  value2: string;
  value3: BigInt;
...
export class MultipleNFT extends ethereum.SmartContract {
  static bind(address: Address): MultipleNFT {
    return new MultipleNFT("MultipleNFT", address);
  }
  ...
  Items(param0: BigInt): MultipleNFT__ItemsResult {
    let result = super.call(
      "Items",
      "Items(uint256):(uint256,address,string,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new MultipleNFT__ItemsResult(
      result[0].toBigInt(),
      result[1].toAddress(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_Items(param0: BigInt): ethereum.CallResult<MultipleNFT__ItemsResult> {
    let result = super.tryCall(
      "Items",
      "Items(uint256):(uint256,address,string,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
  ...
  addItem(supply: BigInt, royalty: BigInt, _uri: string): BigInt {
    let result = super.call(
      "addItem",
      "addItem(uint256,uint256,string):(uint256)",
      [
  ...
  burn(from: Address, id: BigInt, amount: BigInt): boolean {
    let result = super.call("burn", "burn(address,uint256,uint256):(bool)", [
  ...
  try_burn(
    ...
    let result = super.tryCall("burn", "burn(address,uint256,uint256):(bool)", [
      ethereum.Value.fromAddress(from),
      ethereum.Value.fromUnsignedBigInt(id),
      ethereum.Value.fromUnsignedBigInt(amount)
    ]);
  ...
  creatorFee(id: BigInt): BigInt {
    let result = super.call("creatorFee", "creatorFee(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(id)
    ]);
  ...
  try_creatorFee(id: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall("creatorFee", "creatorFee(uint256):(uint256)", [
      ethereum.Value.fromUnsignedBigInt(id)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
